...
// What is window.alert going to show?

let i = 0;

setTimeout(() => window.alert(i), 100); // ?
...
// It's programmed execute the window.alert before 100ms
// but before the current script must complete it.
// So. First does the loop and after it executes
// the window.alert showing "100000000" because i is 1 up to j.
